  ...
  return (
    <div className="inset-y-0 mt-20 right flex-1 bg-gray-900 shadow-lg z-40 flex flex-col border-2 border-gray-400 rounded-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-between p-4 border-b bg-gray-800">
        ...
        <button onClick={onToggle} className="p-1 hover:bg-gray-700 rounded text-gray-200 cursor-pointer">
          ✕
        </button>
      </div>
          ...
          {selectedFile && (
            <div className="flex-1 flex flex-col bg-gray-900 w-full h-[calc(88vh-5rem)] md:h-auto relative">
              ...
              <div className="flex items-center justify-center md:justify-start p-3 bg-gray-800 border-b relative">
                ...
                <button
                  className="absolute left-3 text-xl text-white hover:text-cyan-400 md:hidden cursor-pointer"
                ...
                <button
                  ...
                  className="absolute right-3 p-1 hover:bg-gray-700 rounded cursor-pointer"
                >
              ...
              <button
                className="p-2 bg-gray-800 text-gray-200 hover:bg-gray-700 md:hidden mt-2 rounded cursor-pointer"
                onClick={() => setSelectedFile(null)}
              >
                ← Back to Files
              </button>
